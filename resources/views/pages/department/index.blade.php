      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-lg-6 col-8 mb-2">
            <h5 class="m-0 text-dark"><strong> TMC - Clearance/Manage Others/Department</strong></h5>
          </div><!-- /.col -->
      ...
      <div class="box p-2"><!-- Default box -->
        <div class="card">
          ...
          <div class="box-body" style="padding:10px">
            <button type="button" data-toggle="modal" data-target="#modal-add" class="btn btn-default btn-info btn-sm" style="background-color:#138496;color: white;">New department</button>
              ...
              <thead>
                <tr>
                  <div class="row">
                    <div class="col-lg-8">
                      <th>
                        <h5><strong>List of department</strong></h5>
                      </th>
                    </div>
                    <div class="col-lg-2">
                      <th>
                ...
                <tr>
                  <div class="row">
                    <div class="col-lg-8">
                      <td>
                        <!-- @foreach($cour as $c)
                          @if($depts->id == $c->department_id)

                          {{$c->department_id}}

                          @endif
                        @endforeach -->
                        <strong>{{$depts->department}}</strong>  <?php echo '<br>'. $depts->description; ?>
                      </td>
                    </div>
                    <div class="col-lg-2">
                      <td>
                        <div class="time-label">
                           ...
                           <?php echo ($depts->status == "1")? ' <strong style="color:#28a745;">Active</strong>' : '<strong  style="color:#dc3545;">Unactive</strong>'; ?>
                        </div>
                      </td>
                    </div>
                    <div class="col-lg-2">
                      <td class="project-actions">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item edit" href="#" data-id="{{$depts->id}}" data-department="{{$depts->department}}" data-description="{{$depts->description}}" data-status="{{$depts->status}}" data-toggle="modal" data-target="#modal-update" >Update Info</a>
                            <a class="dropdown-item delete" data-toggle="modal" data-target="#modal-delete" data-id="{{$depts->id}}" data-department="{{$depts->department}}" data-status="{{$depts->status}}" href="#"><?php echo ($depts->status == "1")? '<strong  style="color:#dc3545;">Deactivate</strong> ' : '<strong style="color:#28a745;">Active</strong>'; ?></a>
                          </div>
                      </td>
                    </div>
                  </div>
  ...
  <div class="modal fade" id="modal-add" data-backdrop="static" keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('dept_add') }}" method="POST">
          @csrf
  ...
  <div class="modal fade" id="modal-update" data-backdrop="static" keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('dept_update')}}" method="POST">
          @csrf
        <div class="modal-body">
          <div class="form-group">
            <label>Department</label>
            <input type="hidden" class="e_id" name="id" id="e_id" >
            <input type="text" name="department" id="e_department" class="form-control e_department" placeholder="Enter department" required>
          </div>
          <div class="form-group">
            <label>Description</label>
   ...
   <div class="modal fade" id="modal-delete" data-backdrop="static" keyboard="false">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header" style="background-color:none">
          <h4 class="modal-title titl" >Delete department</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <form action="{{ route('dept_delete')}}" method="POST">
          @csrf
        <div class="modal-body">
          <center>
